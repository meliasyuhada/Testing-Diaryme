...
class PythonTrueCRUD (unittest.TestCase):
    ...
    def test_truecrud_in_python(self):
        ...
        self.driver.save_screenshot(
            "C:\python_selenium\PythonSeleniumProject1\Testing-Diaryme\ss\crud\benar\ss1.png")
        time.sleep(3)
        elem = driver.find_element(
            By.XPATH, "//button[normalize-space()='Login']")
        elem.click()
        self.driver.save_screenshot(
            "C:\python_selenium\PythonSeleniumProject1\Testing-Diaryme\ss\crud\benar\ss2.png")
        time.sleep(3)
        elem = driver.find_element(
            By.XPATH, "//i[@class='bi bi-chevron-down ms-auto']")
        elem.click()
        self.driver.save_screenshot(
            "C:\python_selenium\PythonSeleniumProject1\Testing-Diaryme\ss\crud\benar\ss3.png")
        time.sleep(3)
        elem = driver.find_element(
            By.XPATH, "//span[normalize-space()='Data']")
        elem.click()
        self.driver.save_screenshot(
            "C:\python_selenium\PythonSeleniumProject1\Testing-Diaryme\ss\crud\benar\ss4.png")
        time.sleep(3)
        elem = driver.find_element(
            By.XPATH, "//a[normalize-space()='Add Post']")
        elem.click()
        self.driver.save_screenshot(
            "C:\python_selenium\PythonSeleniumProject1\Testing-Diaryme\ss\crud\benar\ss5.png")
        time.sleep(3)
        ...
        elem = driver.find_element(By.XPATH, "(//button[normalize-space()='Publish'])[1]")
        elem.click()
